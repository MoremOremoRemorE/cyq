...
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" href="../../../static/loginNew/css/normalize.css">
    <link rel="stylesheet" href="../../../static/loginNew/css/login.css">
    <link rel="stylesheet" href="../../../static/loginNew/css/sign-up-login.css">
    <link rel="stylesheet" type="text/css" href="http://www.jq22.com/jquery/font-awesome.4.6.0.css">
    <link rel="stylesheet" href="../../../static/loginNew/css/inputEffect.css" />
                ...
                success:function(data){
                    if(data.code=='200'){
                        if(data.data =='success') {
                            ...
                            setTimeout(alert('密码错误，请重新输入密码'),3000);
                            //     alert('密码错误，请重新输入密码');
                        }else{
                            setTimeout(alert('该用户尚未注册，请先注册'),function (){
    ...
    <style type="text/css">
        ...
        body{
            ...
            background-image: url(../../../static/loginNew/images/snow.jpg);
